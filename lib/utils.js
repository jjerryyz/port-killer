...
export const parseAddress = function (raw) {
    var port = null,
        address = null;
    if (raw[0] == '[') {
...
export const normalizeValues = function (item) {
...
export const emitLines = function (stream) {
    var backlog = '';
...
export const parseLines = function (source) {
    var lines = [];
